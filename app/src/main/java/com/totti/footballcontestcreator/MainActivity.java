	...
	public boolean onNavigationItemSelected(MenuItem item) {
		...
		switch(id) {
			case R.id.nav_tournaments:
				...
				this.getSupportFragmentManager().beginTransaction().replace(R.id.fragment_content, new TournamentListFragment()).commit();
				break;
			case R.id.nav_teams:
				this.setTitle("Teams");
				this.getSupportFragmentManager().beginTransaction().replace(R.id.fragment_content, new TeamListFragment()).commit();
				break;
